...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=20em]{huidigesituatie.jpg}
...
De patch kan niet automatisch worden gedownload en zal dus manueel moeten worden gedownload worden van de ERP provider en beoordeelt of deze effectief nut heeft. Of het nut heeft wordt
 ...
 \begin{figure}[htbp]
    \centering
    \includegraphics[width=20em]{huidigesituatie2.png}
...
\end{figure}
 ...
 \begin{figure}[htbp]
    \centering
    \includegraphics[width=20em]{avantra1.png}
...
nuttige functies heeft zoals huidige versie checken om zeker te zijn dat het goed werd configureert, een back-up maken van de huidige staat, bericht sturen naar de gebruikers om de real time status weer
   ...
   \begin{figure}[htbp]
    \centering
    \includegraphics[width=20em]{avantra2.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=20em]{avantra3.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=20em]{avantra4.png}
