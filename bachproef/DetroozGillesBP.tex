...
\begin{figure}[htbp]
    \centering
    \includegraphics[height=0.7\textwidth,angle=270]{huidigesituatie2.jpg}
    \caption{Bijlage 2: Huidige waar er kan geoptimaliseerd worden}
     \label{bijlage:2}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[height=0.7\textwidth,angle=270]{nieuwesituatie.png}
    \caption{Bijlage 3: Nieuwe situatie met patchautomatisatie}
     \label{bijlage:3}
\end{figure}
